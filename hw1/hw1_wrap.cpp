...
#define SWIG_name_d      "hw1"
#define SWIG_name        hw1
...
SWIG_DEFUN( compute_factorial, _wrap_compute_factorial, std::string() ) {
  unsigned int arg1 ;
  unsigned int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_check_num_args("compute_factorial",args.length(),1,1,0)) {
    SWIG_fail;
  }
  ecode1 = SWIG_AsVal_unsigned_SS_int(args(0), &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "compute_factorial" "', argument " "1"" of type '" "unsigned int""'");
  } 
  arg1 = static_cast< unsigned int >(val1);
  result = (unsigned int)hw1::compute_factorial(arg1);
...
SWIG_DEFUN( test_compute_Euclidean_norm, _wrap_test_compute_Euclidean_norm, std::string() ) {
  Matrix arg1 ;
  void *argp1 ;
  int res1 = 0 ;
  octave_value_list _out;
  ...
  if (!SWIG_check_num_args("test_compute_Euclidean_norm",args.length(),1,1,0)) {
    SWIG_fail;
  }
  {
    res1 = SWIG_ConvertPtr(args(0), &argp1, SWIGTYPE_p_Matrix,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test_compute_Euclidean_norm" "', argument " "1"" of type '" "Matrix""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "test_compute_Euclidean_norm" "', argument " "1"" of type '" "Matrix""'");
    } else {
      arg1 = *(reinterpret_cast< Matrix * >(argp1));
    }
  }
  result = hw1::test_compute_Euclidean_norm(arg1);
  _outv = SWIG_NewPointerObj((new Matrix(static_cast< const Matrix& >(result))), SWIGTYPE_p_Matrix, SWIG_POINTER_OWN |  0 );
  if (_outv.is_defined()) _outp = SWIG_Octave_AppendOutput(_outp, _outv);
  return _out;
fail:
  return octave_value_list();
...
{"compute_factorial",_wrap_compute_factorial,0,0,2,0},
{"test_compute_Euclidean_norm",_wrap_test_compute_Euclidean_norm,0,0,2,0},
{0,0,0,0,0,0}
};
